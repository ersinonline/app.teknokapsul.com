...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    ...
    icon: '📡',
    services: [
      { id: 'turktelekom-internet', name: 'Türk Telekom İnternet', category: 'internet-tv', description: 'Fiber internet ve IPTV paketleri' },
      { id: 'superonline', name: 'Superonline İnternet', category: 'internet-tv', description: 'Hızlı fiber internet ve TV paketleri' },
      { id: 'vodafone-internet', name: 'Vodafone İnternet', category: 'internet-tv', description: 'Fiber internet ve TV hizmetleri' },
      { id: 'turknet', name: 'Türknet İnternet', category: 'internet-tv', description: 'Ekonomik fiber internet paketleri' },
      { id: 'millenicom', name: 'Millenicom İnternet', category: 'internet-tv', description: 'Taahhütsüz mobil internet çözümleri' },
      { id: 'superbox', name: 'Turkcell Superbox', category: 'internet-tv', description: 'Dijital TV platformu ve internet paketleri' },
