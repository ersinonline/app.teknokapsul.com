...
export const BudgetOverview = () => {
  ...
  const overBudgetCategories = Object.entries(budget.categories)
    ...
    .map(([category]) => DEFAULT_CATEGORIES[category]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">{formatCurrency(remainingBudget.toString())}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">
              {DEFAULT_CATEGORIES[topSpendingCategory[0]]}
            </p>
          </div>
        </div>
      </div>
