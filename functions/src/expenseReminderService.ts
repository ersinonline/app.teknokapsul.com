...
import { sendExpenseReminder } from './emailService';
    ...
    try {
      ...
      for (const userDoc of usersSnapshot) {
        ...
        try {
          ...
          const userName = userProfile?.displayName || userProfile?.firstName || 'Kullanıcı';
          ...
          for (const expenseDoc of expensesSnapshot.docs) {
            ...
            try {
              const reminderData: ExpenseReminderData = {
                to_email: userEmail,
                to_name: userName,
              ...
              await sendExpenseReminder(reminderData);
              successfulReminders++;
 ...
 */
export const checkExpenseRemindersManual = functions.https.onCall(async (data, context) => {
